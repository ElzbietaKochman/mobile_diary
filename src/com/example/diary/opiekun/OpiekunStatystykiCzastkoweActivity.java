...
public class OpiekunStatystykiCzastkoweActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_opiekun_statystyki_czastkowe);
		...
		spinner2.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(OpiekunStatystykiCzastkoweActivity.this, android.R.layout.simple_spinner_item, listaPrzedmiot);
