...
public class UczenArchiwumObecnosciActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_uczen_archiwum_obecnosci);
		...
		if(iloscDni>0){
			tv.setText("Twoje nieobecnoœci, rok szkolny "+rok_szkolny+", semestr "+semestr+".");
		...
		for(int a=0;a<iloscDni;a++){
			...
			tv.setText("Brak nieobecnosci roku szkolnym "+rok_szkolny+", semestrze zimowym.");
		}
		...
		for(int a=0;a<iloscDni;a++){
			...
			nieobecnosci.addView(pusta);
			TextView tv2 = new TextView(this);
			tv2.setText("Brak nieobecnosci roku szkolnym "+rok_szkolny+", semestrze letnim.");
		nieobecnosci.addView(tv2);
		}
