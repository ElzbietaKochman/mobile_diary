...
public class UczenArchiwumOgloszeniaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_uczen_archiwum_ogloszenia);
		...
		tv1.setText("Tablica og³oszeñ, rok szkolny "+rokW);
